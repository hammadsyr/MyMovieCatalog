...
public class MovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.hammad.mymoviecatalog.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.hammad.mymoviecatalog.EXTRA_ITEM";
